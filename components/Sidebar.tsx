...
const Sidebar = () => {
  ...
  return (
    <div className="hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full">
      ...
      <div className="space-y-2.2 mt-4 mb-2.5 xl:ml-24">
      ...
      <button className="hidden text-[#d9d9d9] xl:inline ml-auto bg-[#1d9bf0] rounded-full w-56 py-2 text-lg font-bold shadow-md hover:bg-[#1a8cd8]">
        Tweet
      </button>
